...
const citadelCore = [
  ...
  },
  {
    ...
    text: 'regional only · private endpoints · no training use',
  },
]
...
const boundaryFacts = [
  ...
  { id: 'regional-ai', text: 'Regional Azure AI only; Global/DataZone denied' },
...
const considerations = [
  ...
  { id: 'governance', text: 'AI-governance metadata only; no production inference' },
  { id: 'failclosed', text: 'Exact regions, IDs, CIDRs, DNS and policy versions remain fail-closed' },
]
      ...
      <div className={`${styles.body} content-frame content-gutter`}>
        ...
        <header className={styles.header}>
          ...
          <Editable as="p" id="phase3-azure.subtitle" className={styles.subtitle} multiline>
            A private regional Citadel AI core operates inside Azure Landing Zone guardrails, with explicit Stratton subscription separation, warm recovery and independent assurance.
          </Editable>
        </header>
        ...
        <div className={styles.azureGrid}>
          <section className={`${styles.surface} ${styles.azureCanvas}`} aria-label="AI core inside governed landing-zone guardrails">
            <div className={styles.azureDiagramLead}>
              ...
              <span className={styles.regionBadge}>
                ...
                <Editable as="span" id="phase3-azure.diagram.region">EU/EEA regional only</Editable>
              </span>
            </div>
            ...
            <div className={styles.alzGuardrailFrame}>
              ...
              <div className={styles.guardrailDomainGrid}>
                ...
                >
                  {(item) => (
                    <article className={styles.guardrailDomainCard}>
                ...
                <EditableList
                  ...
                  items={runtimePath}
                  keyOf={(item) => item.id}
                  className={styles.runtimePathRibbon}
                ...
                <div className={styles.citadelCore}>
                  ...
                  >
                    {(item) => (
                      <article className={styles.citadelCoreCard}>
                ...
                <div className={styles.dependencyFanout}>
              ...
              <div className={styles.subscriptionStrip}>
                ...
                >
                  {(item) => (
                    <article className={`${styles.subscriptionBoundaryCard} ${styles[`${item.tone}Boundary`]}`}>
          ...
          <aside className={styles.azureSide} aria-label="Azure design objectives and considerations">
            ...
            <section className={`${styles.surface} ${styles.boundaryFactPanel}`}>
            ...
            <section className={`${styles.surface} ${styles.considerationsPanel}`}>
              <div className={styles.azureRailHeading}>
