...
const actualChecks = [
  { id: 'pester', value: '55/55', label: 'Pester IaC' },
  { id: 'psrule', value: '47/47', label: 'PSRule' },
      ...
      <div className={`${styles.body} content-frame content-gutter`}>
        ...
        <div className={styles.testingGrid}>
          <aside className={`${styles.surface} ${styles.actualChecksPanel}`}>
            ...
            >
              {(item) => (
                <article className={styles.actualCheck}>
          ...
          <section className={`${styles.surface} ${styles.plannedGatesPanel}`}>
            ...
            >
              {(item) => {
                ...
                return (
                  <article className={styles.plannedGateCard}>
                    ...
                    <div className={styles.gateSection}>
                      <Editable as="span" id={`phase8-tests.planned.${item.id}.methodLabel`} className={styles.gateSectionLabel}>Method / condition</Editable>
                      <Editable as="p" id={`phase8-tests.planned.${item.id}.method`} multiline>{item.method}</Editable>
                    </div>
                    <div className={styles.gateSection}>
                      <Editable as="span" id={`phase8-tests.planned.${item.id}.thresholdLabel`} className={styles.gateSectionLabel}>Threshold</Editable>
                      <Editable as="p" id={`phase8-tests.planned.${item.id}.threshold`} className={styles.gateThreshold} multiline>{item.threshold}</Editable>
                    </div>
                    <div className={styles.gateSection}>
                      <Editable as="span" id={`phase8-tests.planned.${item.id}.consequenceLabel`} className={styles.gateSectionLabel}>Release consequence</Editable>
