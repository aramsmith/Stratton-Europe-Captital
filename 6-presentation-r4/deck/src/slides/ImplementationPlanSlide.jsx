...
const planMetrics = [
  ...
  { id: 'work', value: '4', label: 'work packages' },
      ...
      <div className={`${styles.body} content-frame content-gutter`}>
        ...
        <header className={styles.header}>
          ...
          <Editable as="p" id="phase4-plan.subtitle" className={styles.subtitle} multiline>
            The approved Azure design becomes one modular package, deployed only in dependency-safe sequence; unresolved owner inputs remain visible stop gates.
          </Editable>
        </header>

        <section className={`${styles.surface} ${styles.deliveryMap}`}>
            ...
            {(item) => {
              ...
              return (
                <div className={styles.deliveryBandWrap}>
                  <article className={styles.deliveryBand}>
          ...
          <div className={styles.planPrinciple}>
        ...
        <div className={styles.planBottom}>
          ...
          <EditableList
            ...
            items={releaseGates}
            keyOf={(item) => item.id}
            className={styles.releaseGates}
            itemClassName={styles.releaseGateShell}
          >
            {(item) => {
              const Icon = item.icon
              return (
                <article className={`${styles.surface} ${styles.releaseGate}`}>
