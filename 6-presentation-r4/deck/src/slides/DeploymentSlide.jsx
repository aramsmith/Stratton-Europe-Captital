      ...
      <div className={`${styles.body} content-frame content-gutter`}>
        ...
        <header className={styles.header}>
          ...
          <Editable as="p" id="phase7-deploy.subtitle" className={styles.subtitle} multiline>
            An authorised Azure deployment attempt follows the approved dependency sequence, stops on any control failure and returns immutable execution evidence.
          </Editable>
        </header>
            ...
            {(item) => {
              ...
              return (
                <div className={styles.deploymentStepWrap}>
                  <article className={styles.deploymentStep}>
        ...
        <div className={styles.deploymentBottom}>
          <section className={`${styles.surface} ${styles.deployControlCard}`}>
