...
if (
    [int]$releaseManifest.upstream.modelPlanRevision -ne 14 -or
    ...
    [string]$releaseManifest.upstream.phase5ModelPlan.sha256 -cne
        'a4af30ebc44cb985c1881d2508eb2bdb8680e480c0262682fe34de2ebb40638b' -or
    [string]$releaseManifest.canonicalization.hashRoot -cne '5-coding-r3' -or
    [string]$releaseManifest.canonicalization.canonicalManifestPath -cne
        '5-coding-r3/stratton-phase-5-hashes.json'
) {
    throw 'Release manifest does not bind revisioned Phase 5 candidate model-plan revision 14.'
}
