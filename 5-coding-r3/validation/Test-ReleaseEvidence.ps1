...
if (
    ...
    [string]$release.canonicalization.hashRoot -cne '5-coding-r3' -or
...
if (
    ...
    [string]$phase5ModelPlan.planRevision -cne '14' -or
    ...
    [string]$phase5ModelPlan.revisionedCandidate.packageRoot -cne '5-coding-r3' -or
    [string]$phase5ModelPlan.revisionedCandidate.manifestPath -cne
        '5-coding-r3/stratton-phase-5-hashes.json' -or
...
if (
    [string]$release.upstream.phase5ModelPlan.path -cne
        '0-coordination/stratton-model-plan-revision-14.json' -or
    [string]$release.upstream.phase5ModelPlan.sha256 -cne
        'a4af30ebc44cb985c1881d2508eb2bdb8680e480c0262682fe34de2ebb40638b'
) {
    throw 'Release manifest does not bind the approved model-plan revision 14 path and hash.'
}
if (
...
if (
    ...
    [string]$phaseHash.canonicalization.hashRoot -cne '5-coding-r3'
) {
