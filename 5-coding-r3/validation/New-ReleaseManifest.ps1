...
param(
    ...
    [string]$Phase5ModelPlanRevision = '14'
)
...
if ($phase5ModelPlanSha256 -cne 'a4af30ebc44cb985c1881d2508eb2bdb8680e480c0262682fe34de2ebb40638b') {
    throw 'Phase 5 model-plan revision 14 hash mismatch.'
}
...
$manifest = [ordered]@{
    ...
    canonicalization = [ordered]@{
        hashRoot = '5-coding-r3'
        canonicalManifestPath = '5-coding-r3/stratton-phase-5-hashes.json'
        pathSeparator = '/'
        sort = 'ordinal'
