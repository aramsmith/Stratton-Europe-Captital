...
$compiledOutput = @(
  ...
  --file ".\5-coding-r3\infra\parameters\$Environment.bicepparam" `
  --stdout 2>&1 |
...
$preflight = @(
  '-NoProfile',
  '-File', (Join-Path $CaseRoot '5-coding-r3\tests\iac\Invoke-DeploymentPreflight.ps1'),
...
```powershell
$Template = Join-Path $CaseRoot '5-coding-r3\infra\main.bicep'
...
$AssuranceTemplate = Join-Path $CaseRoot '5-coding-r3\infra\assurance-main.bicep'
