...
const standardAgents = [
  { id: 'aff-0', code: 'AFF-0', title: 'Coordinate', model: 'Evidence-bound', role: 'Intake · interview · lifecycle state' },
  { id: 'aff-1', code: 'AFF-1', title: 'Requirements', model: 'Evidence-bound', role: 'Human interview · governed baseline' },
  { id: 'aff-2', code: 'AFF-2', title: 'TOGAF Architecture', model: 'Evidence-bound', role: 'Business · Data · App · Technology' },
  { id: 'aff-3', code: 'AFF-3', title: 'Azure Design', model: 'Evidence-bound', role: 'Landing zones · CAF · WAF · controls' },
  { id: 'aff-4', code: 'AFF-4', title: 'Implementation Plan', model: 'Evidence-bound', role: 'Dependencies · Bicep · rollback' },
  { id: 'aff-5', code: 'AFF-5', title: 'Coding', model: 'Evidence-bound', role: 'Complete build · local validation' },
  {
    id: 'aff-6',
    code: 'AFF-6',
    title: 'Architecture Review Board presentation',
    model: 'Evidence-bound',
    role: 'Approved evidence · board narrative',
    quote: 'Present before you spend',
  },
]
...
const reviewerAgents = [
  {
    ...
    model: 'gpt-5.6-luna',
    role: 'Active Phase 6 route: model-opposite challenge of logic, traceability, and unsupported claims.',
  },
  {
    id: 'aff-b',
    code: 'AFF-B',
    ...
    model: 'gpt-5.6-terra',
    role: 'Active Phase 6 route: independent review of privacy, sovereignty, compliance, and controls.',
  },
]
...
function AgentTile({ item, compact = false }) {
  return (
    <article
      className={`${styles.agentTile} ${compact ? styles.compactAgentTile : ''}`}
    ...
    >
      ...
      {item.quote && (
        <Editable as="q" id={`agentic-roster.agents.${item.id}.quote`} className={styles.agentQuote}>
          {item.quote}
        </Editable>
      )}
    </article>
        ...
        <section className={styles.rosterPanel}>
          <div className={styles.rosterHeader}>
            ...
            <Editable as="p" id="agentic-roster.roster.subtitle">
              Current Phase 6 routes · other phases bind to model receipts
            </Editable>
          </div>
          ...
          <div className={styles.supportingLanes}>
            ...
            <section className={`${styles.supportingLane} ${styles.reviewLane}`}>
              <div className={styles.laneLabel}>
                ...
                <Editable as="span" id="agentic-roster.review.rule">Phase 6 · Luna + Terra · same hashes</Editable>
              </div>
              <EditableList
