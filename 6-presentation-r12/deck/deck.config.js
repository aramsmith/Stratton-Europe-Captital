...
import ModelPortfolioSlide from './src/slides/ModelPortfolioSlide.jsx'
...
export default {
  ...
  description: 'Stratton Europe Capital twenty-slide executive architecture assurance candidate',
  meta: {
    seededTemplate: false,
    contentStatus: 'r12-human-visual-remediation-integrated-validation-pending',
    evidenceBoundary: 'R12 changes only the requested visual presentation behaviour: Slide 10 uses six equal stacked handoff cards; Slide 11 increases model and scope typography while retaining equal cards; Slide 12 replaces the rotating border with a non-rotating linear light sweep; Slide 14 aligns release inventory, retained local run, supply-chain evidence and Azure SKU panels; Slide 16 adds green actual-check and cyan planned-gate hover/focus lighting; Slide 17 equalises and enlarges cost cards and adds green benefit-card hover/focus lighting; Slide 18 repeats the approved risk-to-mitigation sequence and remains static under reduced motion; all slide copy, claims, prices, references, IDs, slide count, phase boundaries and approvals remain unchanged from frozen r11; Phase 7/8 remain uninvoked; the candidate remains unapproved; no deployment, runtime test, realised benefit or approval is claimed',
