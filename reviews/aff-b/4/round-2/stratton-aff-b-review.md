...
- SHA-256: `4b92d1abf5990245914ceaee355b145d52a3c25486ab9ebb273862a39d9a20f8` — **MATCH**
- Canonical schema: **PASS**
- Bound artifacts: `14` — **all hashes recomputed and matched**
- Final AFF-A: `cases/Stratton-Europe-Captital/reviews/aff-a/4/round-4/stratton-aff-a-review.json` / `73656e7433c9af192d385115b91ac6d8e952b1eb3fa3d683ea6daf360c03b0a9`
...
- `4-implementation-plan/stratton-cc-001-phase-4-amendment.md section 3`
- `4-implementation-plan/stratton-implementation-catalogue-cc-001-proposed.json WP-05, softwarePackageAcceptance and identityMappings.assurance-build-release-deploy`
...
- `4-implementation-plan/stratton-implementation-catalogue-cc-001-proposed.json validation and parameter evidence preserve trust generically but do not bind immutable trust snapshots to each signed record`
