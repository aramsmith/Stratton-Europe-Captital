    ...
    <Slide index={index} className={styles.decisionSummary}>
      <div className={`${styles.body} content-frame content-gutter`}>
        <div className={styles.header}>
          ...
          <Editable as="p" id="decision.subtitle" className={styles.subtitle} multiline>Approve the evidence-backed architecture and coding baseline as the controlled reference, with a gated roadmap for owner evidence and future validation.</Editable>
