...
param(
    ...
    [string]$Phase5ModelPlanRevision = '12'
)
...
if (
    ...
    [string]$phase5ModelPlan.phase5Assignment.runScopedOverrideDecision -cne 'APPROVED' -or
    [string]$phase5ModelPlan.phase5Assignment.finalisationActualRuntimeModelId -cne 'gpt-5.6-sol' -or
    [string]$phase5ModelPlan.candidate.path -cne '5-coding/stratton-phase-5-hashes.json' -or
