...
if (
    [int]$releaseManifest.upstream.modelPlanRevision -ne 12 -or
    [string]$releaseManifest.upstream.phase5ModelPlan.path -cne
        '0-coordination/stratton-model-plan-revision-12.json'
) {
    throw 'Release manifest does not bind Phase 5 model-plan revision 12.'
}
