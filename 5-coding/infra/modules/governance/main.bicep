...
resource denyGlobalAiPolicy 'Microsoft.Authorization/policyDefinitions@2023-04-01' = {
  name: 'stratton-deny-global-and-datazone-ai'
  properties: {
    displayName: 'Deny Global and DataZone AI deployment names'
    policyType: 'Custom'
    mode: 'All'
    policyRule: {
      if: {
...
resource initiative 'Microsoft.Authorization/policySetDefinitions@2023-04-01' = {
  ...
  properties: {
    ...
    policyDefinitions: [
      ...
      {
        policyDefinitionId: denyGlobalAiPolicy.id
      }
      {
