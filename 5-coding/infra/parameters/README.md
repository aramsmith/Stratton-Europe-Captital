...
- Any `REQUIRED_OWNER_INPUT` value is rejected by `tests/iac/Invoke-DeploymentPreflight.ps1`.
- Empty mandatory structures/collections are rejected by preflight before Azure execution.
