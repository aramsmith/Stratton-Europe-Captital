import type { ModelTaskClass, ModelTier } from "./model-routing-policy.js";
...
export interface TransitionPolicyEvidence {
  ...
  readonly modelResidencyEvidencePresent: boolean;
...
export interface AnalysisRunRecord {
  ...
  readonly modelTaskClass: ModelTaskClass;
  readonly modelTier: ModelTier;
  readonly modelRouteReason: string;
  readonly modelReasoningEffort: "low" | "medium" | "high";
...
export interface AnalysisRunObservation {
  readonly modelValidationStatus: "PASS" | "FAIL";
  readonly modelLatencyMilliseconds?: number;
  readonly modelInputTokens?: number;
  readonly modelOutputTokens?: number;
  readonly modelObservedCostUsd?: number;
