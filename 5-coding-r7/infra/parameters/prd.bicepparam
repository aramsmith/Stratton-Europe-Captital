...
param modelCapabilityAndQuotaEvidenceByEnvironment = {
  dev: {
    approvalState: 'REQUIRED_OWNER_INPUT'
    capabilityEvidenceId: 'REQUIRED_OWNER_INPUT'
    capabilityEvidenceSha256: 'REQUIRED_OWNER_INPUT'
    quotaEvidenceId: 'REQUIRED_OWNER_INPUT'
    quotaEvidenceSha256: 'REQUIRED_OWNER_INPUT'
    target: {
      environment: 'dev'
      subscriptionId: 'REQUIRED_OWNER_INPUT'
      resourceGroupName: 'REQUIRED_OWNER_INPUT'
      location: 'REQUIRED_OWNER_INPUT'
      accountName: 'REQUIRED_OWNER_INPUT'
    }
    portfolioBindingSha256: 'REQUIRED_OWNER_INPUT'
  }
  tst: {
    approvalState: 'REQUIRED_OWNER_INPUT'
    capabilityEvidenceId: 'REQUIRED_OWNER_INPUT'
    ...
    dev: {
      openAi: {
        ...
        deployments: [
          {
            modelKey: 'luna'
            name: 'gpt-56-luna-dev'
            skuName: 'DataZoneStandard'
            versionUpgradeOption: 'NoAutoUpgrade'
            raiPolicyName: 'Microsoft.Default'
            modelFormat: 'OpenAI'
            deploymentType: 'DataZoneStandard'
            fineTuningEnabled: false
          }
          {
            modelKey: 'terra'
            name: 'gpt-56-terra-dev'
            skuName: 'DataZoneStandard'
            versionUpgradeOption: 'NoAutoUpgrade'
            raiPolicyName: 'Microsoft.Default'
            modelFormat: 'OpenAI'
