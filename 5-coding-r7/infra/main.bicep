...
param modelPortfolioDeploymentEnabled bool = false
...
module DU11 './deployments/DU-11/main.bicep' = if (deploymentUnitId == 'DU-11') {
  ...
  params: {
    environment: environment
    settings: du11
    modelPortfolioDeploymentEnabled: modelPortfolioDeploymentEnabled
    modelNameVersionAndQuota: modelNameVersionAndQuota
    modelCapabilityAndQuotaEvidenceByEnvironment: modelCapabilityAndQuotaEvidenceByEnvironment
