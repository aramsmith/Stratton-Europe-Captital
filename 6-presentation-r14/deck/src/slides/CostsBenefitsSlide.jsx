      ...
      <div className={`${styles.body} content-frame content-gutter`}>
        ...
        <header className={styles.header}>
          ...
          <Editable as="p" id="costs-benefits.subtitle" className={styles.subtitle} multiline>
            A dated public-retail Azure input snapshot shows the cost shape of the approved design; the on-premises comparator is illustrative only, not a customer quote, procurement estimate or assured business case.
          </Editable>
        </header>
        ...
        <div className={styles.costGrid}>
          <section className={`${styles.surface} ${styles.azureCostPanel}`}>
            <div className={styles.costHero}>
              ...
              <span className={styles.liveApiTag}>
                ...
                <Editable as="span" id="costs-benefits.azure.api">DATED API SNAPSHOT</Editable>
              </span>
            </div>

            <div className={`${styles.costStack} ${slideStyles.costStack}`} aria-label="Azure monthly cost distribution">
            ...
            <EditableList
              ...
              keyOf={(item) => item.id}
              className={`${styles.costRows} ${slideStyles.costRows}`}
              itemClassName={styles.costRowShell}
            >
              {(item) => (
                <article className={`${styles.costRow} ${slideStyles.costRow}`}>
          ...
          <aside className={styles.costSide}>
            <section className={`${styles.surface} ${styles.onPremPanel}`}>
              ...
              <div className={styles.onPremBars}>
                <div className={styles.onPremBarRow}>
                  ...
                  <div className={styles.onPremTrack}><span style={{ '--bar-width': '60%' }} /></div>
                ...
                <div className={styles.onPremBarRow}>
                  ...
                  <div className={styles.onPremTrack}><span style={{ '--bar-width': '40%' }} /></div>
            ...
            <section className={`${styles.surface} ${styles.assumptionsPanel} ${slideStyles.assumptionsPanel}`}>
              ...
              >
                {(item) => (
                  <span className={`${styles.assumptionItem} ${slideStyles.assumptionItem}`}>
                    <span aria-hidden="true" />
        ...
        >
          {(item) => (
            <article className={`${styles.benefitMatrixCard} ${slideStyles.benefitInteractive}`}>
