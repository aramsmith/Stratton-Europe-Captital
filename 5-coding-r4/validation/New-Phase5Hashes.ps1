...
if (
    [int]$releaseManifest.upstream.modelPlanRevision -ne 15 -or
    ...
    [string]$releaseManifest.upstream.phase5ModelPlan.sha256 -cne
        '7ce3ff77d47384ceaf3e0515b3350578831b5a2fedfcbeba4e586399dc9f6fb4' -or
    [string]$releaseManifest.canonicalization.hashRoot -cne '5-coding-r4' -or
    [string]$releaseManifest.canonicalization.canonicalManifestPath -cne
        '5-coding-r4/stratton-phase-5-hashes.json'
) {
    throw 'Release manifest does not bind revisioned Phase 5 candidate model-plan revision 15.'
}
