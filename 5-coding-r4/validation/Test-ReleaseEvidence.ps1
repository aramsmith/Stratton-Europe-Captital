...
if (
    ...
    [string]$release.canonicalization.hashRoot -cne '5-coding-r4' -or
...
if (
    ...
    [string]$phase5ModelPlan.planRevision -cne '15' -or
...
if (
    [string]$release.upstream.phase5ModelPlan.path -cne
        '0-coordination/stratton-model-plan-revision-15.json' -or
    [string]$release.upstream.phase5ModelPlan.sha256 -cne
        '7ce3ff77d47384ceaf3e0515b3350578831b5a2fedfcbeba4e586399dc9f6fb4'
) {
    throw 'Release manifest does not bind the approved model-plan revision 15 path and hash.'
}
if (
...
if (
    ...
    throw 'Release manifest does not faithfully disclose the authority conflicts, owner controls and retained minor gaps.'
}
...
if (
    ...
    [string]$phaseHash.canonicalization.hashRoot -cne '5-coding-r4'
) {
