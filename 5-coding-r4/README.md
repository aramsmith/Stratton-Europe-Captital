...
revisioned Phase 5 candidate beneath `5-coding-r4/`, so the path mapping is:

| Approved logical path | Phase 5 path |
|---|---|
| `iac/infra/` | `5-coding-r4/infra/` |
| `iac/contracts/`, application and database work | `5-coding-r4/app/` |
| `iac/tests/` | `5-coding-r4/tests/` |
| `iac/validation/` | `5-coding-r4/validation/` |
| release and deployment instructions | `5-coding-r4/deploy/` and the root release manifest |
