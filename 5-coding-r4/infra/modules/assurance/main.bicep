...
resource evidenceReaderCopierWriteAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(
    evidenceContainer.id,
    assurance.evidenceReaderCopierPrincipalId,
    assurance.evidenceReaderCopierRoleDefinitionId
  )
  scope: evidenceContainer
  properties: {
    principalId: assurance.evidenceReaderCopierPrincipalId
...
output retentionActivationState string = assurance.retentionFinalization.state
output dataAdmissionEnabled bool = assurance.retentionFinalization.dataAdmissionEnabled