...
param(
    ...
    [string]$Phase5ModelPlanRevision = '13'
)
...
if ($phase5ModelPlanSha256 -cne '9c18ca9fadea478470a2f23e7bd50a68b276b55f3fe9accdc299b82c7ad0284a') {
    throw 'Phase 5 model-plan revision 13 hash mismatch.'
}
...
$manifest = [ordered]@{
    ...
    canonicalization = [ordered]@{
        ...
        canonicalManifestPath = '5-coding-r2/stratton-phase-5-hashes.json'
        pathSeparator = '/'
        sort = 'ordinal'
