    ...
    dev: {
      serviceBus: {
        ...
        roleAssignments: [
          ...
          {
            identityName: 'uami-audit-export'
            roleDefinitionId: '69a216fc-b8fb-44d8-bc22-1f3c2cd27a39'
          }
        ]
      }
    ...
    dev: {
      ...
      apiApp: {
        ...
        environmentVariables: [
          ...
          {
            name: 'AZURE_SERVICEBUS_QUEUE_AUDIT_EXPORT'
      ...
      apis: [
        {
          ...
          policyXml: 'REQUIRED_OWNER_INPUT'
        }
      ]
    }
    tst: {
...
param du16 = {
  ...
  assuranceByEnvironment: {
    prd: {
      ...
      deliveryPrincipalId: 'REQUIRED_OWNER_INPUT'
      deliveryRoleDefinitionId: 'ba92f5b4-2d11-453d-a403-e96b0029c9fe'
