...
) "immutabilityLocked=$([bool](Get-ObjectValue $params 'du16.assuranceByEnvironment.prd.immutabilityLocked')) legalHoldEnabled=$([bool](Get-ObjectValue $params 'du16.assuranceByEnvironment.prd.legalHoldEnabled'))" 'DU-16'
