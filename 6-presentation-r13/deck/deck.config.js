...
export default {
  ...
  description: 'Stratton Europe Capital twenty-slide executive architecture assurance candidate r13',
  meta: {
    seededTemplate: false,
    contentStatus: 'r13-slide11-ai-techniques-validated',
    evidenceBoundary: 'R13 changes only the Slide 11 bottom rail requested by the human architect: the visible Promotion guardrails rail is replaced by AI Techniques used with Prompt Engineering, Loop Engineering and Graph Engineering - Chain blocks. The underlying governed model-portfolio controls and evidence remain unchanged metadata; all other slide copy, claims, prices, references, IDs, slide count, phase boundaries and approvals remain unchanged from frozen r12; Phase 7/8 remain uninvoked; the candidate remains unapproved; no deployment, runtime test, realised benefit or approval is claimed',
